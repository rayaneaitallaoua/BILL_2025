...
F_ORF <- function(name_ORF, df_gen, info_ech){
  ...
  identifiant_header <- paste0("VAR", info_ech, "_" , accession_genome, ":", pos_begin, "-", pos_end)
...
list_ORF_gen_ref <- list()
  ...
  for (i in list_ORF_mu) {
    ...
    identifiant_header <- paste0("REF_" ,accession_genome, ":", pos_begin, "-", pos_end)
...
```{r}
df_gen_P901_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "M"
df_gen_P902_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "M"
df_gen_P903_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "M"
df_gen_P904_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "R" "M" "K"
df_gen_P905_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "M"
df_gen_P906_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "M" "Y"
df_gen_P907_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "M"
df_gen_P908_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "M" "K"
df_gen_P909_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "R" "M" "K"
df_gen_P9010_iupac$new_alt_iupac %>% unique() #"C" "T" "G" "A" "M"

#M, R, K, Y

# il y a des M partout
which(df_gen_P901_iupac$new_alt_iupac == "M") %>% length()
which(df_gen_P902_iupac$new_alt_iupac == "M") %>% length()
which(df_gen_P903_iupac$new_alt_iupac == "M") %>% length()
which(df_gen_P904_iupac$new_alt_iupac == "M") %>% length()
which(df_gen_P905_iupac$new_alt_iupac == "M") %>% length()
which(df_gen_P906_iupac$new_alt_iupac == "M") %>% length()
which(df_gen_P907_iupac$new_alt_iupac == "M") %>% length()
which(df_gen_P908_iupac$new_alt_iupac == "M") %>% length()
which(df_gen_P909_iupac$new_alt_iupac == "M") %>% length()
which(df_gen_P9010_iupac$new_alt_iupac == "M") %>% length()
#1 seul M à chaque fois

df_gen_P901_iupac[which(df_gen_P901_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
df_gen_P902_iupac[which(df_gen_P902_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
df_gen_P903_iupac[which(df_gen_P903_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
df_gen_P904_iupac[which(df_gen_P904_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
df_gen_P905_iupac[which(df_gen_P905_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
df_gen_P906_iupac[which(df_gen_P906_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
df_gen_P907_iupac[which(df_gen_P907_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
df_gen_P908_iupac[which(df_gen_P908_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
df_gen_P909_iupac[which(df_gen_P909_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
df_gen_P9010_iupac[which(df_gen_P901_iupac$new_alt_iupac == "M"), "Locus.tag"] %>% as.character()
#ORF64

#R
which(df_gen_P901_iupac$new_alt_iupac == "R") %>% length() #0
which(df_gen_P902_iupac$new_alt_iupac == "R") %>% length() #0
which(df_gen_P903_iupac$new_alt_iupac == "R") %>% length() #0
which(df_gen_P904_iupac$new_alt_iupac == "R") %>% length() #6
which(df_gen_P905_iupac$new_alt_iupac == "R") %>% length() #0
which(df_gen_P906_iupac$new_alt_iupac == "R") %>% length() #0
which(df_gen_P907_iupac$new_alt_iupac == "R") %>% length() #0
which(df_gen_P908_iupac$new_alt_iupac == "R") %>% length() #0
which(df_gen_P909_iupac$new_alt_iupac == "R") %>% length() #27
which(df_gen_P9010_iupac$new_alt_iupac == "R") %>% length() #0

df_gen_P904_iupac[which(df_gen_P904_iupac$new_alt_iupac == "R"), "Locus.tag"] %>% unique() %>% as.vector()
#ORF 33, 41, 40
df_gen_P909_iupac[which(df_gen_P909_iupac$new_alt_iupac == "R"), "Locus.tag"] %>% unique() %>% as.vector()
#ORF 33, 41, 40

#K
which(df_gen_P904_iupac$new_alt_iupac == "K") %>% length()#1
which(df_gen_P908_iupac$new_alt_iupac == "K") %>% length()#1
which(df_gen_P909_iupac$new_alt_iupac == "K") %>% length()#1


df_gen_P904_iupac[which(df_gen_P904_iupac$new_alt_iupac == "K"), "Locus.tag"] %>% as.character() # Pas sur un ORF donc osef
df_gen_P908_iupac[which(df_gen_P908_iupac$new_alt_iupac == "K"), "Locus.tag"] %>% as.character() #CyHV3_ORF64
df_gen_P909_iupac[which(df_gen_P909_iupac$new_alt_iupac == "K"), "Locus.tag"] %>% as.character() #CyHV3_ORF64

#Y
which(df_gen_P906_iupac$new_alt_iupac == "Y") %>% length()
df_gen_P906_iupac[which(df_gen_P906_iupac$new_alt_iupac == "Y"), "Locus.tag"] %>% as.character() #CyHV3_ORF64
...
df_gen_P901_iupac[which(df_gen_P901_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow() #2204
df_gen_P902_iupac[which(df_gen_P902_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow()
df_gen_P903_iupac[which(df_gen_P903_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow()
df_gen_P904_iupac[which(df_gen_P904_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow()
df_gen_P905_iupac[which(df_gen_P905_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow()
df_gen_P906_iupac[which(df_gen_P906_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow()
df_gen_P907_iupac[which(df_gen_P907_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow()
df_gen_P908_iupac[which(df_gen_P908_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow()
df_gen_P909_iupac[which(df_gen_P909_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow()
df_gen_P9010_iupac[which(df_gen_P901_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% nrow()

df_gen_P901_iupac[which(df_gen_P901_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% is.na() %>% sum() #2194
df_gen_P902_iupac[which(df_gen_P902_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% is.na() %>% sum() #2186
df_gen_P903_iupac[which(df_gen_P903_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% is.na() %>% sum() #2183
df_gen_P904_iupac[which(df_gen_P904_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% is.na() %>% sum() #2190
df_gen_P905_iupac[which(df_gen_P905_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% is.na() %>% sum() #2188
df_gen_P906_iupac[which(df_gen_P906_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% is.na() %>% sum() #2190
df_gen_P907_iupac[which(df_gen_P907_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"]%>% is.na() %>% sum() #2192
df_gen_P908_iupac[which(df_gen_P908_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% is.na() %>% sum() #2187
df_gen_P909_iupac[which(df_gen_P909_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% is.na() %>% sum() #2186
df_gen_P9010_iupac[which(df_gen_P901_iupac$Locus.tag == "CyHV3_ORF64"), "ALT_IUPAC"] %>% is.na() %>% sum() #2185

summary(c(10, 18, 21, 14, 16, 14, 12, 17, 18, 19))
