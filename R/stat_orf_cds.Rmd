...
Combien de mutations dans le génome, nb de mutations moyennes par ORF et par CDS
```{r}
...
nb_mean_snp_ORF[which(nb_mean_snp_ORF$GEN == "P15"),] %>%
  ...
  scale_x_discrete(limits = function(x) head(x[order(nb_mean_snp_ORF$nb_SNP, decreasing = TRUE)], 25)) +  
  scale_y_continuous(expand = expansion(mult = c(0, 0.1))) +
...
nb_mean_snp_ORF[which(nb_mean_snp_ORF$GEN == "P30"),] %>%
  ...
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5), 
        axis.text.x = element_text(angle = 45, hjust = 1, size = 6), legend.position = "none") +
  scale_x_discrete(limits = function(x) head(x[order(nb_mean_snp_ORF$nb_SNP, decreasing = TRUE)], 25)) +  # Sélection des 15 ORF les plus fréquents
  scale_y_continuous(expand = expansion(mult = c(0, 0.1))) +
...
nb_mean_snp_ORF %>% nrow()
nb_mean_snp_ORF$ORF %>% unique() %>% length() #152
nb_mean_snp_ORF$ORF_NAME %>% unique() %>% length() #152

ORF_1_to_19<- unique(nb_mean_snp_ORF$ORF)[1:19] #longueur 19
ORF_20_to_38<- unique(nb_mean_snp_ORF$ORF)[20:38] #longueur 19
ORF_39_to_57<- unique(nb_mean_snp_ORF$ORF)[39:57] #longueur 19
ORF_58_to_76<- unique(nb_mean_snp_ORF$ORF)[58:76] #longueur 19
ORF_77_to_95<- unique(nb_mean_snp_ORF$ORF)[77:95] #longueur 19
ORF_96_to_114<- unique(nb_mean_snp_ORF$ORF)[96:114] #longueur 19
ORF_115_to_133<- unique(nb_mean_snp_ORF$ORF)[115:133] #longueur 19
ORF_134_to_152<- unique(nb_mean_snp_ORF$ORF)[134:152] #longueur 19

nb_mean_snp_ORF %>% nrow()
nb_mean_snp_ORF[which(nb_mean_snp_ORF$ORF %in% ORF_1_to_19),] %>%
  ggplot(aes(x = GEN, y = nb_SNP)) +
  geom_bar(aes(fill = TRAITEMENT), stat = "identity", position = position_dodge(1), width = 0.8) +
  geom_text(aes(label = nb_SNP, group = TRAITEMENT) ,stat = "identity",  position = position_dodge(1), size = 2, color = "black", vjust = -0.5) + 
  scale_fill_manual(values = c("#339966","#FF6666", "#0099CC"))+
  scale_y_continuous(expand = expansion(mult = c(0, 0.3))) +
  facet_wrap(~ ORF_NAME, ncol = 4, scales = "free") +
  theme_bw() +
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5), 
        axis.text.x = element_text(angle = 45, hjust = 1, size = 6), 
        strip.text.x = element_text(size = 7)) +
...
ggsave(".\\images_scripts\\nb_mean_snp_GEN_ORF_1.png", width = 10, height = 8)

nb_mean_snp_ORF[which(nb_mean_snp_ORF$ORF %in% ORF_20_to_38),] %>%
  ggplot(aes(x = GEN, y = nb_SNP)) +
  geom_bar(aes(fill = TRAITEMENT), stat = "identity", position = position_dodge(1), width = 0.8) +
  geom_text(aes(label = nb_SNP, group = TRAITEMENT) ,stat = "identity",  position = position_dodge(1), size = 2, color = "black", vjust = -0.5) + 
  scale_fill_manual(values = c("#339966","#FF6666", "#0099CC"))+
  ...
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5), 
        ...
        strip.text.x = element_text(size = 7)) +
  labs(title = "Nombre de SNP par génération pour chaque ORF", y = "Effectif", x = "Génération") 
ggsave(".\\images_scripts\\nb_mean_snp_GEN_ORF_2.png", width = 10, height = 8)

nb_mean_snp_ORF[which(nb_mean_snp_ORF$ORF %in% ORF_39_to_57),] %>%
  ggplot(aes(x = GEN, y = nb_SNP)) +
  geom_bar(aes(fill = TRAITEMENT), stat = "identity", position = position_dodge(1), width = 0.8) +
  geom_text(aes(label = nb_SNP, group = TRAITEMENT) ,stat = "identity",  position = position_dodge(1), size = 2, color = "black", vjust = -0.5) + 
  scale_fill_manual(values = c("#339966","#FF6666", "#0099CC"))+
  ...
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5), 
        ...
        strip.text.x = element_text(size = 7)) +
  labs(title = "Nombre de SNP par génération pour chaque ORF", y = "Effectif", x = "Génération") 
ggsave(".\\images_scripts\\nb_mean_snp_GEN_ORF_3.png", width = 10, height = 8)

nb_mean_snp_ORF[which(nb_mean_snp_ORF$ORF %in% ORF_58_to_76),] %>%
  ggplot(aes(x = GEN, y = nb_SNP)) +
  geom_bar(aes(fill = TRAITEMENT), stat = "identity", position = position_dodge(1), width = 0.8) +
  geom_text(aes(label = nb_SNP, group = TRAITEMENT) ,stat = "identity",  position = position_dodge(1), size = 2, color = "black", vjust = -0.5) + 
  scale_fill_manual(values = c("#339966","#FF6666", "#0099CC"))+
  ...
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5), 
        ...
        strip.text.x = element_text(size = 7)) +
  labs(title = "Nombre de SNP par génération pour chaque ORF", y = "Effectif", x = "Génération") 
ggsave(".\\images_scripts\\nb_mean_snp_GEN_ORF_4.png", width = 10, height = 8)

nb_mean_snp_ORF[which(nb_mean_snp_ORF$ORF %in% ORF_77_to_95),] %>%
  ggplot(aes(x = GEN, y = nb_SNP)) +
  geom_bar(aes(fill = TRAITEMENT), stat = "identity", position = position_dodge(1), width = 0.8) +
  geom_text(aes(label = nb_SNP, group = TRAITEMENT) ,stat = "identity",  position = position_dodge(1), size = 2, color = "black", vjust = -0.5) + 
  scale_fill_manual(values = c("#339966","#FF6666", "#0099CC"))+
  ...
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5), 
        ...
        strip.text.x = element_text(size = 7)) +
  labs(title = "Nombre de SNP par génération pour chaque ORF", y = "Effectif", x = "Génération") 
ggsave(".\\images_scripts\\nb_mean_snp_GEN_ORF_5.png", width = 10, height = 8)

nb_mean_snp_ORF[which(nb_mean_snp_ORF$ORF %in% ORF_96_to_114),] %>%
  ggplot(aes(x = GEN, y = nb_SNP)) +
  geom_bar(aes(fill = TRAITEMENT), stat = "identity", position = position_dodge(1), width = 0.8) +
  geom_text(aes(label = nb_SNP, group = TRAITEMENT) ,stat = "identity",  position = position_dodge(1), size = 2, color = "black", vjust = -0.5) + 
  scale_fill_manual(values = c("#339966","#FF6666", "#0099CC"))+
  ...
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5), 
        ...
        strip.text.x = element_text(size = 7)) +
  labs(title = "Nombre de SNP par génération pour chaque ORF", y = "Effectif", x = "Génération") 
ggsave(".\\images_scripts\\nb_mean_snp_GEN_ORF_6.png", width = 10, height = 8)

nb_mean_snp_ORF[which(nb_mean_snp_ORF$ORF %in% ORF_115_to_133),] %>%
  ggplot(aes(x = GEN, y = nb_SNP)) +
  geom_bar(aes(fill = TRAITEMENT), stat = "identity", position = position_dodge(1), width = 0.8) +
  geom_text(aes(label = nb_SNP, group = TRAITEMENT) ,stat = "identity",  position = position_dodge(1), size = 2, color = "black", vjust = -0.5) + 
  scale_fill_manual(values = c("#339966","#FF6666", "#0099CC"))+
  ...
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5), 
        ...
        strip.text.x = element_text(size = 7)) +
  labs(title = "Nombre de SNP par génération pour chaque ORF", y = "Effectif", x = "Génération") 
ggsave(".\\images_scripts\\nb_mean_snp_GEN_ORF_7.png", width = 10, height = 8)

nb_mean_snp_ORF[which(nb_mean_snp_ORF$ORF %in% ORF_134_to_152),] %>%
  ggplot(aes(x = GEN, y = nb_SNP)) +
  geom_bar(aes(fill = TRAITEMENT), stat = "identity", position = position_dodge(1), width = 0.8) +
  geom_text(aes(label = nb_SNP, group = TRAITEMENT) ,stat = "identity",  position = position_dodge(1), size = 2, color = "black", vjust = -0.5) + 
  scale_fill_manual(values = c("#339966","#FF6666", "#0099CC"))+
  ...
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5), 
        ...
        strip.text.x = element_text(size = 7)) +
  labs(title = "Nombre de SNP par génération pour chaque ORF", y = "Effectif", x = "Génération") 
ggsave(".\\images_scripts\\nb_mean_snp_GEN_ORF_8.png", width = 10, height = 8)
...
C'est un peut compliqué de savoir quels CDS sont impactés par les SV
(combien de SV par CDS)
...
```{r}
df[which(df$nb_mut_sv > 1), ] %>%
  ggplot(aes(x = GENERATION, y = nb_mut_sv, fill = GENERATION)) +
  geom_bar(stat = "identity") +
  scale_fill_brewer(palette = "Accent") +
  facet_wrap(~ ORF) +
  theme_bw()

df[which(df$nb_mut_sv > 1 & df$GENERATION == "P15"), ] %>%
...
df[which(df$nb_mut_sv > 1 & df$GENERATION == "P30"), ] %>%
  ggplot(aes(x = ORF, y = nb_mut_sv)) +
  geom_bar(stat = "identity") +
  #scale_fill_brewer(palette = "Accent") +
  facet_wrap(~ GENERATION, ncol = 1) +
...
df[which(df$nb_mut_sv > 1 & df$GENERATION == "P50"), ] %>%
  ggplot(aes(x = ORF, y = nb_mut_sv)) +
  geom_bar(stat = "identity") +
  #scale_fill_brewer(palette = "Accent") +
  facet_wrap(~ GENERATION, ncol = 1) +
...
df[which(df$nb_mut_sv > 1 & df$GENERATION == "P65"), ] %>%
  ggplot(aes(x = ORF, y = nb_mut_sv)) +
  geom_bar(stat = "identity") +
  #scale_fill_brewer(palette = "Accent") +
  facet_wrap(~ GENERATION, ncol = 1) +
...
df[which(df$nb_mut_sv > 1 & df$GENERATION == "P90"), ] %>%
  ggplot(aes(x = ORF, y = nb_mut_sv)) +
  geom_bar(stat = "identity") +
  #scale_fill_brewer(palette = "Accent") +
  facet_wrap(~ GENERATION, ncol = 1) +
