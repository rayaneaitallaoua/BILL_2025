...
CyHV3_ref_2 <- CyHV3_ref_2 %>% mutate(TRAITEMENT = case_when(CyHV3_ref_2$ECH <= 5 ~ "Froid", CyHV3_ref_2$ECH > 5 ~ "Chaud"))
...
nb_sv_ORF <- nb_sv_ORF %>% mutate(TRAITEMENT = case_when(nb_sv_ORF$ECHANTILLON <= 5 ~ "Froid", 
                                                         nb_sv_ORF$ECHANTILLON > 5 ~ "Chaud"))
