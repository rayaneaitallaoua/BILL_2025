...
#ggsave(plot = P_nb_mu_2, "nb_moy_mutation_Gen_T.png", height = 5, width = 7)
P_nb_mu_1
P_nb_mu_2
...
count_snp_sv_type[,c("GENERATION", "ECHANTILLON", "COUNT", "SV_SNP", "TRAITEMENT")] %>% unique() %>%
  ...
  theme_classic() +
  theme(axis.title.y = element_text(angle = 0, vjust = 0.5))
#ggsave("boxplot_nb_snp_sv_TG.png", height = 5, width = 7)
...
#ggsave("nb_snp_sv_TG.png", height = 5, width = 7)
```
